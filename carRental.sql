...
DROP TABLE IF EXISTS `car_rental_db`.`table_customer`;

CREATE TABLE IF NOT EXISTS `car_rental_db`.`table_customer` (
...
insert into
    `car_rental_db`.`table_customer`(`id`,`first_name`,`middle_name`,`last_name`,`email`,`salt`,`password`)
values (1,"sven","eig","doglas", "sveneigdoglas@exmaple.com", "94c0d3","bea7577f575fa5fed776410679451f74");


DROP TABLE if exists  `car_rental_db`.`table_car_category` ;
CREATE TABLE IF NOT EXISTS `car_rental_db`.`table_car_category` (
    `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
...
insert into
    `car_rental_db`.`table_car_category`(`id`,`category_name`,`description`)
values (1,"Toyota Camry","Toyota Camry"),(2, "BMW 650", "BMW 650");


DROP TABLE if exists  `car_rental_db`.`table_car` ;
CREATE TABLE IF NOT EXISTS `car_rental_db`.`table_car` (
    `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
...
insert into
    `car_rental_db`.`table_car`(`id`,`category_id`,`plate`,`status`)
values (1, 1, "TC7698", 1),(2, 1, "TC7998", 1),(3, 2, "BMW998", 1),(4, 2, "BMW654", 1);

DROP TABLE if exists  `car_rental_db`.`table_rental_order` ;
CREATE TABLE IF NOT EXISTS `car_rental_db`.`table_rental_order` (
    `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
